...
const provider = new ethers.JsonRpcApiProvider(ALCHEMY_MAINNET_URL);
//第1种输入abi的方式:复制abi全文
...
const abiERC20 = [
    ...
    "function balanceOf(address) view returns (uitn)",
];
...
const main = async () => {
    ...
    console.log(`总供给: ${formatEther(totalSupplyDAI)}`)
